...
path_images_from_camera = "X_Center_Data/Face_Track_Data/"
...
def return_features_mean_personX(path_face_personX):
    ...
    # personX of N pic x 128D -> 1 x 128D
...
def main():
    ...
    with open("X_Center_Data/features_all.csv", "w", newline="") as csvfile:
        ...
        for person in person_list:
            ...
            logging.info('\n')
        logging.info(" Save all the features of faces registered into: X_Center_Data/features_all.csv")
